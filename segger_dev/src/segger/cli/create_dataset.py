...
def create_dataset(args: Namespace):
    ...
    transcripts_path = Path(args.dataset_dir) / args.sample_tag / args.transcripts_file
    boundaries_path = Path(args.dataset_dir) / args.boundaries_file
    ...
    sample.save_dataset_for_segger(
        ...
        neg_sampling_ratio_approx=args.neg_sampling_ratio_approx,
